...
RUN bun install -g vscode-langservers-extracted
RUN apk update
...
RUN wget https://github.com/leona/helix-gpt/releases/download/0.25/helix-gpt-0.25.js -O /tmp/helix-gpt.js
# RUN go get github.com/asty-org/asty
# RUN go install github.com/asty-org/asty
